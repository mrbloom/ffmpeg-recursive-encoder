    ...
    for root, _, files in os.walk(source_folder):
        for file in files:
            if file.lower().endswith((".mkv", ".avi", ".mxf", ".mpg")):
                ...
                dest_file = os.path.splitext(source_file)[0] + "_qsync_1pass_encoded.mp4"
                ...
                if not os.path.exists(dest_file):
                    ...
                    if file_size1 == file_size2:
                        ...
                        if audio_streams == 1:
                            subprocess.run(["ffmpeg",  "-i", source_file,"-write_tmcd", "false",
                            ...
                            subprocess.run(["ffmpeg", "-i", source_file,
